...
//    ApItem ap_Item = null;
    ...
    //0 : 총점, 1 : ssid, 2 : pw, 3 : packet,packet rule , 4 : packet snif
...
//        ap_Item.setSec_score(ap_Item.getSecScore());
//        Log.d(TAG, "SecurityEstimater: final = "+ap_Item.getSecScore());
